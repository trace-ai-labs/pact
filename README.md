...
PACT measures whether a deployed LLM agent keeps following a binding compliance
rule when its own objective (speed, cost, customer satisfaction, conversion)
